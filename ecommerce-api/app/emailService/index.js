...
async function sendEmailResetPassword(receiverEmail, resetPasswordUrl) {
  try {
    ...
    const mailOptions = {
      from: config.sendgrid.fromEmail,
      to: receiverEmail,
      subject: 'BK Shop! Reset password request',
      html: content
    };
...
async function sendEmailContactEmail(receiverEmail) {
  try {
    ...
    const mailOptions = {
      from: config.sendgrid.fromEmail,
      to: receiverEmail,
      subject: 'BK Shop! Re: your contact 1',
      html: content
    };
    sgMail.send(mailOptions)
  } catch (err) {
...
async function sendEmailCreateOrderEmail(receiverEmail) {
  try {
    ...
    const mailOptions = {
      from: config.sendgrid.fromEmail,
      to: receiverEmail,
      subject: 'BK Shop! Your order has been created',
      html: content
    };
    sgMail.send(mailOptions);
  } catch (err) {
...
async function sendEmailShippedOrder(id) {
  ...
  try {
    ...
    const mailOptions = {
      from: config.sendgrid.fromEmail,
      to: user.email,
      subject: 'BK Shop! Your order was shipping',
      html: content
    };
    sgMail.send(mailOptions);
  } catch (err) {
...
async function sendEmailConfirmOrderEmail(id) {
  ...
  try {
    ...
    const mailOptions = {
      from: config.sendgrid.fromEmail,
      to: user.email,
      subject: 'BK Shop! Your order has been confirmed',
      html: content
    };
    sgMail.send(mailOptions);
  } catch (err) {
...
async function sendEmailCompleteOrderEmail(id) {
  ...
  try {
    ...
    const mailOptions = {
      from: config.sendgrid.fromEmail,
      to: user.email,
      subject: 'BK Shop! Your order has been completed',
      html: content
    };
    sgMail.send(mailOptions);
  } catch (err) {
